...
siteurl='http://www.faxuan.net/site/14/03/22.html'
codeurl='http://xf.faxuan.net/service/gc.html?tt='+str(tt)
#loginurl='http://www.faxuan.net/shop/api/xf_login?'
#loginurl='http://xf.faxuan.net/bss/service/userService!doUserLogin.do?userAccount=xxx&userPassword=xxx&code=gh4a&rid=6317deaa5b651475b38d306da5c7a791&key=42'
...
while True:
	...
	loginurl='http://xf.faxuan.net/bss/service/userService!doUserLogin.do?userAccount=xxx&userPassword=xxx&code='+str(code)+'&rid='+str(mycookie['rid'])
